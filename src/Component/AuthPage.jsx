    ...
    return (
        <div className=" -mt-[70px] slide-bg relative w-full h-[737px] bg-cover bg-center bg-[url('/src/img/Cover.png')] flex justify-center items-center w-[100] h-[737px] bg-[url('/src/Conponit/Container.webp')] bg-cover bg-cente">
            <form
                ...
                className="flex shadow-xl w-[900px] rounded-xl p-6 bg-white/70 backdrop-blur-md border border-gray-300"
            >
                <iframe src="https://my.spline.design/genkubgreetingrobot-BEJT5t4bdIAhgacAXRzXgd9K/" frameborder="0" id="d-box" class="w-[500px] h-[500px] rounded-md"></iframe>
              ...
              ${emailError ? "border-red-500 bg-white" : email ? "border-green-500 bg-green-100" : "border-gray-300 bg-white"}`}
                        />
                        {emailError && (
                            <p className="text-red-500 text-sm mt-1">Emailda xatolik bor!</p>
                        )}
                    </div>
              ...
              ${passError ? "border-red-500 bg-white" : password ? "border-green-500 bg-green-100" : "border-gray-300 bg-white"}`}
                        ...
                        {passError && (
                            <p className="text-red-500 text-sm mt-1">
                                Parol 6–16 ta belgidan iborat bo‘lishi kerak!
                            </p>
                        )}
                    </div>
                    ...
                    <button
                        type="submit"
                        disabled={isloading}
                        className={`${isloading ? "bg-[#6fc06f]" : ""} flex items-center gap-2 justify-center w-full py-2 rounded-lg bg-green-500 text-white font-semibold hover:bg-green-600 transition-all`}
                    >
